...
import jwt from 'jsonwebtoken';   //to generate token for auth
import userModel from '../models/usermodel.js';
import transporter from '../config/nodemailer.js';

export const register = async (req,res)=>{  //async header function with parameters request and response [THIS IS USER REGISTRATION FUNCTION]
    ...
    try{
        ...
        const mailOptions={
            ...
            text: `Hey there! Your account with the email: ${email} has been successfully created.`
        }
